...
- Hallwang can be reached from Salzburg city by car within about 15 minutes, but is a bit hard to reach by public transport. Therefore, we are going to arrange a shuttle service from Salzburg main station to the venue. Please let us know in the response form (further below!) if you would like to use this <nobr>service. 🚕</nobr>
